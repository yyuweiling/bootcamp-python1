...
input_first = input("Do you want to go first? (y/n) ")

if input_first == "y":
    while tokens_pile1 >0 or tokens_pile2 >0:
        ...
        if tokens_pile1 == 0 and tokens_pile2 ==0:
                print("Player wins!")
        ...
        # Choose a random (nonempty) pile
            ...
            # Display the result
            print(tokensRemoved, "tokens removed by computer from pile", computerPileChoice)
            print()
            print("Token piles:")
